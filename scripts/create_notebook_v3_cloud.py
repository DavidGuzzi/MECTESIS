"""
Genera notebooks/experimentos_univariados_v3_cloud.ipynb
Versión para ejecutar en Vertex AI Workbench (Google Cloud).

Diferencias respecto a v3:
  - Logging dual: stdout + archivo run_YYYYMMDD_HHMMSS.log en results/univariate_v3/
  - GPU auto-detect: Chronos usa CUDA si está disponible
  - run_exp usa log() en lugar de print()

Ejecutar: python scripts/create_notebook_v3_cloud.py
"""
...
out_path = Path("notebooks/experimentos_univariados_v3_cloud.ipynb")
